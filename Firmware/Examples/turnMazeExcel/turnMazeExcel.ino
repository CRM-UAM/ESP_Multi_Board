...
#define ONE_CELL_DISTANCE 130/(2*3.14*R_WHEEL) * 180 *1.10//13cm to tics (1,08 coeficiente de correccion)
#define speed_to_counts(a) (180*(a)/(2*3.1415*R_WHEEL))
#define counts_to_speed(a) ((a)*(2*3.14*R_WHEEL)/180)
